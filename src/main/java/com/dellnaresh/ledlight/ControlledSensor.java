...
public class ControlledSensor {
        ...
        public static void main(String[] args) throws InterruptedException {
            ...
            final GpioPinDigitalInput pir = gpio.provisionDigitalInputPin(RaspiPin.GPIO_07);
            // provision gpio pin #01 as an output pin and turn on
            final GpioPinDigitalOutput pin = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_06, "MyLED", PinState.LOW);
